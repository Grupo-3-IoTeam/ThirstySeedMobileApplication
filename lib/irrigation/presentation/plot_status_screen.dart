              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: NetworkImage(plot.imageUrl ?? 'https://via.placeholder.com/150'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildInfoBox(plot.name ?? 'No disponible', width: 170),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    _buildInfoBox('${plot.extension ?? 0} m2', width: 170),
                  ],
                ),
                const SizedBox(height: 10),
                Row(
                  ...
                  children: [
                    ...
                    _buildInfoBox('${plot.installedNodes ?? 0}', width: 170),
                  ],
                ),
                const SizedBox(height: 10),
                Row(
                  ...
                  children: [
                    ...
                    _buildInfoBox(plot.lastIrrigationDate ?? 'No disponible', width: 170),
                  ],
                ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'Ubicación: ${node.location ?? 'No disponible'}',
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      color: Colors.grey[700],
                                    ),
                                  ),
                                  Text('Humedad: ${node.moisture ?? 'No disponible'}%'),
                                  Text('Indicador: ${node.indicator ?? 'No disponible'}'),
                                  Text(
                                    'Estado: ${node.status ?? 'No disponible'}',
                                    style: TextStyle(
